    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch(item.getItemId()){
            case R.id.action_add:
                //Take User to add activity
                if(firebaseAuth!=null&&user!=null){
                    startActivity(new Intent(ListJournalActivity.this,PostJournalActivity.class));
                    //finish();
                }
                break;
            case R.id.action_signout:
                ...
                if(firebaseAuth!=null&&user!=null){
                    ...
                    startActivity(new Intent(ListJournalActivity.this,MainActivity.class));
                    //finish();
                }
                break;
        }
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        if(!queryDocumentSnapshots.isEmpty()){
                            ...
                            journalRecyclerAdapter = new JournalRecyclerAdapter(ListJournalActivity.this,
                                    journalList);
